...
date: today
abstract: "This is a document designed to orient analyst to data curated from REDCap questionnaires. The codebook and all datasets can be found in the *MARS Pre-Curated Data/Visit/* folder"
format: pdf
editor: visual
toc: true
toc-depth: 4
...
Each dataset contains two ID variables. To link the questionnaire data to the EMA data, use the **mars_id** variable. The **record_id** variable is a REDCap-generated ID with likely no use as a primary key.
